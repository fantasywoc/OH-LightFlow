...
const int32_t STRING_INDEX_DIFF_LIST = 0x0100000e;
const int32_t STRING_INDEX_SAME_LIST = 0x0100000f;
const int32_t STRING_INDEX_SAME_LIST_COMPOSABLE_TYPE = 0x01000010;
const int32_t STRING_INDEX_SAME_LIST_MULTI_TYPE = 0x01000011;
const int32_t STRING_INDEX_SAME_LIST_ONE_TYPE = 0x01000012;
const int32_t STRING_LOCATION_REASON = 0x01000008;
const int32_t STRING_MEDIA_REASON = 0x0100001b;
